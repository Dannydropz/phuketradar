            ...
            (async () => {
              ...
              try {
                ...
                const hotKeywords = [
                  ...
                  "ปะทะ", "เฮโรอีน", "ขายยา", "QR", "คิวอาร์", "สติ๊กเกอร์", "ติดประกาศ", "Telegram", "เทเลแกรม",

                  // CRIME & POLICE
                  "อุบัติเหตุ", "จับกุม", "จับ", "ตำรวจ", "สถานีตำรวจ", "คดี", "โจรกรรม", "ลักทรัพย์", "ขโมย",
                  "กระเป๋า", "วิ่งราว", "ฆาตกรรม", "ฆ่า", "แทง", "ยิง", "ปืน", "มีด", "ทำร้ายร่างกาย",
                  "ทำร้าย", "ต่อย", "ตบ", "ทะเลาะ", "ชกต่อย", "ตีกัน", "ยาเสพติด", "ยาบ้า", "ยาไอซ์",
                  "โคเคน", "กัญชา", "ค้ายา", "ฉ้อโกง", "หลอกลวง", "โกง", "แก๊งคอลเซ็นเตอร์", "ออนไลน์",
                  "บุกจับ", "ตรวจค้น", "หมายจับ", "ประกันตัว", "ฝากขัง", "สอบสวน", "พยาน", "CCTV",
                  "กล้องวงจรปิด", "หนีคดี", "หลบหนี", "ผู้ต้องหา", "ตรวจจับ", "ด่านตรวจ", "โอเวอร์สเตย์",

                  // TRAFFIC & ACCIDENTS
                  "ชน", "ชนกัน", "รถชน", "เฉี่ยวชน", "คว่ำ", "พลิกคว่ำ", "ตก", "ล้ม",
                  "เจ็บ", "บาดเจ็บ", "เสียชีวิต", "ดับ", "ตาย", "สาหัส", "โคม่า", "มอเตอร์ไซค์",
                  "จักรยานยนต์", "บิ๊กไบค์", "รถเก๋ง", "รถกระบะ", "รถตู้", "รถบรรทุก", "รถสิบล้อ",
                  "รถเครน", "รถแท็กซี่", "ตุ๊กตุ๊ก", "สงขลา", "เมาแล้วขับ", "แอลกอฮอล์", "เป่าแอลกอฮอล์",
                  "ใบขับขี่", "ใบขับขี่สากล", "ไม่มีใบขับขี่", "หมวกกันน็อค", "ไม่สวมหมวก", "เขาป่าตอง",
                  "ทางโค้ง", "ลื่น", "ฝนตก", "ถนนเปียก", "รถติด", "จราจร", "ปิดถนน", "ชิงเลน",
                  "ย้อนศร", "ฝ่าไฟแดง", "หนีที่เกิดเหตุ", "ชนแล้วหนี",

                  // NIGHTLIFE & ENTERTAINMENT
                  "บาร์", "ผับ", "คลับ", "สถานบันเทิง", "ดิสโก้เธค", "บังลา", "ปิดร้าน", "เปิดเกินเวลา",
                  "ใบอนุญาต", "ไม่มีใบอนุญาต", "บุกตรวจ", "เสียงดัง", "ร้องเรียน", "เมา", "เมาหัวราน้ำ",
                  "ทะเลาะวิวาท", "แสงสีเสียง", "โชว์", "สาวประเภทสอง", "ปิงปองโชว์", "สปา", "นวด",

                  // TOURISM & FOREIGNERS
                  "นักท่องเที่ยว", "ฝรั่ง", "ต่างชาติ", "ชาวรัสเซีย", "ชาวจีน", "ชาวอินเดีย", "ชาวออสเตรเลีย",
                  "ชาวอังกฤษ", "ชาวอเมริกัน", "ชาวเกาหลี", "ชาวยูเครน", "ชาวอิสราเอล", "ชาวคาซัคสถาน",
                  "นักท่องเที่ยวคุณภาพ", "วีซ่า", "เกินกำหนด", "ตม.", "ตรวจคนเข้าเมือง", "สนามบิน",
                  "เที่ยวบิน", "โรงแรม", "รีสอร์ท", "เช่ารถ", "เช่ามอเตอร์ไซค์", "เจ็ทสกี", "หาดป่าตอง",
                  "หาดกะรน", "หาดกะตะ", "หาดสุรินทร์", "หาดบางเทา", "หาดไนหาน", "หาดกมลา", "ราไวย์",
                  "ถลาง", "กะทู้", "เมืองเก่า",

                  // WEATHER & ENVIRONMENT
                  "พายุ", "ฝนตกหนัก", "น้ำท่วม", "น้ำป่า", "น้ำรอระบาย", "ดินถล่ม", "ลมแรง", "คลื่นสูง",
                  "คลื่นลมแรง", "กระแสน้ำ", "ธงแดง", "จมน้ำ", "สูญหาย", "กู้ภัย", "ช่วยเหลือ", "อุทกภัย",
                  "ไฟป่า", "ไฟไหม้", "เพลิงไหม้", "แผ่นดินไหว", "สึนามิ", "ปิดอ่าว", "ปิดเกาะ", "เรือล่ม",
                  "ห้ามลงเล่นน้ำ", "มลพิษ", "ฝุ่น PM2.5", "คราบน้ำมัน", "ขยะ", "ปะการัง",

                  // ANIMALS & WILDLIFE
                  "สุนัข", "หมาจรจัด", "หมากัด", "พิษสุนัขบ้า", "งู", "จงอาง", "งูเห่า", "งูเหลือม",
                  "ลิง", "ช้าง", "ฉลาม", "แมงกะพรุน", "แมงกะพรุนกล่อง", "วาฬ", "โลมา", "เต่า", "ตะกวด",

                  // HEALTH & HOSPITALS
                  "โรงพยาบาล", "วชิระภูเก็ต", "กรุงเทพภูเก็ต", "ห้องฉุกเฉิน", "รถพยาบาล", "กู้ชีพ",
                  "มูลนิธิ", "กุศลธรรม", "เจ็บป่วย", "ไข้เลือดออก", "อาหารเป็นพิษ", "ตกจากที่สูง",
                  "กระโดด", "พลัดตก",
                  ...
                  "สนามบินภูเก็ต", "ช้า", "ยกเลิก", "ท่าเรือ", "เรือ", "สปีดโบ๊ท", "เฟอร์รี่",
                  "รถเมล์", "สมาร์ทบัส", "แกร็บ", "โบลท์", "ค่าโดยสาร", "โก่งราคา", "ปฏิเสธผู้โดยสาร",
                ...
                translation = await translatorService.translateAndRewrite(
                  ...
                  post.sourceUrl // Pass sourceUrl so comments can be scraped if interestScore >= 4
                );
